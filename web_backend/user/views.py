...
def login():
    ...
    if password == is_null[2]:
        ...
        response.set_cookie('uuid', uuid, max_age=settings.Config.cookies_timeout, domain='sit.dev-web.com:9528')
        response.set_cookie('username', is_null[1], max_age=settings.Config.cookies_timeout, domain='sit.dev-web.com:9528')
        ...
        if settings.Config.jwt_on == 1:
            ...
            response.set_cookie('token', token, max_age=settings.Config.cookies_timeout, domain='sit.dev-web.com:9528')
        return response
    else:
        data["code"] = 9995
        data["msg"] = "账号或密码错误！"
