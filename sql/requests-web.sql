...
CREATE TABLE `jk_testcase` (
  ...
  `rely_data` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '依赖的接口返回值数据对象',
  `rely_mode` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '使用依赖的方式：1：header  2：params 3：body',
