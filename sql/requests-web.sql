...
CREATE TABLE `jk_testcase` (
  ...
  `rely_mode` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '使用依赖的方式：1：header  2：params 3：data',
  `rely_key` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '使用依赖的key',
  `rely_data` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '用户填写的读取依赖的接口返回值数据对象，格式与断言数据一样',
