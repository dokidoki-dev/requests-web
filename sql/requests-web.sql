...
CREATE TABLE `jk_testcase` (
  ...
  `url` varchar(255) COLLATE utf8mb4_bin NOT NULL COMMENT '请求链接  mode: env表示使用环境变量,un_env表示使用用户上传数据',
  ...
  `header` text COLLATE utf8mb4_bin NOT NULL COMMENT '请求头 mode: env表示使用环境变量,un_env表示使用用户上传数据',
